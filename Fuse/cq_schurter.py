...
class cq_schurter:
    ...
    def make_body_Schurter_0031_8002(self, params, modelID):
        ...
        case1 = (
            cq.Workplane("XY")
            .workplane(centerOption="CenterOfMass", offset=0.0 - 0.1)
            .moveTo(0.0, 0.0)
            .circle(3.2 / 2.0, False)
            .extrude(H + 1.0)
        )
        case = case.cut(case1)
        #
        case1 = (
            cq.Workplane("XY")
            .workplane(centerOption="CenterOfMass", offset=H / 2.0)
            .moveTo(0.0, 0.0)
            .circle(6.3 / 2.0, False)
            .extrude(H + 0.2)
        )
        case = case.cut(case1)
        #
    ...
    def make_body_Schurter_0031_8201(self, params, modelID):
        ...
        case1 = (
            cq.Workplane("XY")
            .workplane(centerOption="CenterOfMass", offset=0.0)
            .moveTo(((W / 2.0) - (tdx / 2.0)), ((L / 2.0) - (tdt / 2.0)))
            .rect(tdx, tdt)
            .extrude(H)
        )
        ...
        case1 = (
            cq.Workplane("XY")
            .workplane(centerOption="CenterOfMass", offset=0.0)
            .moveTo(((W / 2.0) - (tdx / 2.0)), 0.0 - ((L / 2.0) - (tdt / 2.0)))
            .rect(tdx, tdt)
            .extrude(H)
        )
        case1 = case1.faces(">Z").edges("<X").chamfer(tdx / 5.0, tdx / 5.0)
        ...
        case1 = (
            cq.Workplane("XY")
            .workplane(centerOption="CenterOfMass", offset=0.0)
            .moveTo(0.0 - ((W / 2.0) - (tdx / 2.0)), ((L / 2.0) - (tdt / 2.0)))
            .rect(tdx, tdt)
            .extrude(H)
        )
        case1 = case1.faces(">Z").edges("<X").chamfer(tdx / 5.0, tdx / 5.0)
        ...
        case1 = (
            cq.Workplane("XY")
            .workplane(centerOption="CenterOfMass", offset=0.0)
            .moveTo(0.0 - ((W / 2.0) - (tdx / 2.0)), 0.0 - ((L / 2.0) - (tdt / 2.0)))
            .rect(tdx, tdt)
            .extrude(H)
        )
        case1 = case1.faces(">Z").edges("<X").chamfer(tdx / 5.0, tdx / 5.0)
    ...
    def make_body_Schurter_FAB_0031_355x(self, params, modelID):
        ...
        case1 = (
            cq.Workplane("YZ")
            .workplane(centerOption="CenterOfMass", offset=W - 2.0)
            .moveTo(0.0, H / 2.0)
            .rect(6.0, 1.8)
            .extrude(3.0)
        )
    ...
    def make_pin_Schurter_0031_8002(self, params, modelID):
        ...
        for p in pin:
            ...
            if p[0] == "rect":
                ...
                case1 = qrt._make_arrow_pin(
                    w, l, h, 3.5, (h + H) - (2.0 * l), H / 2.0, "arrow"
                )
    ...
    def make_npth_pin(self, params, modelID):
        ...
        if npthpin == None:
            case = (
                cq.Workplane("XY")
                .workplane(centerOption="CenterOfMass", offset=1.0)
                .moveTo(0.0, 0.0)
                .circle(0.001, False)
                .extrude(0.001)
            )
