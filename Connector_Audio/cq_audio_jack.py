...
class cq_audio_jack:
    ...
    def make_top_Jack_3_5mm_Neutrik(self, params):
        ...
        case = (
            cq.Workplane("YZ")
            .workplane(offset=0.0 - (W / 2.0) - (2.0 * AW1))
            .polyline(pts)
            .close()
            .extrude(AW1)
        )
        ...
        case1 = (
            cq.Workplane("YZ")
            .workplane(offset=0.0 - (W / 2.0) - (3.0 * AW1))
            .moveTo(0.0, H)
            .circle(3.5 / 2.0, False)
            .extrude(3.0 * AW1)
        )
        case = case.cut(case1)
    ...
    def make_case_Jack_3_5mm_Ledino(self, params):
        ...
        case1 = (
            cq.Workplane("XY")
            .workplane(offset=H)
            .moveTo(0.0 - ((W / 2.0) - 1.5), 0.0 - ((L / 2.0) - 1.5))
            .circle(1.2 / 2.0, False)
            .extrude(0.8)
        )
        ...
        case1 = (
            cq.Workplane("XY")
            .workplane(offset=H)
            .moveTo(0.0 - ((W / 2.0) - 1.5), ((L / 2.0) - 1.5))
            .circle(1.2 / 2.0, False)
            .extrude(0.8)
        )
        case1 = case1.faces(">Z").fillet(0.45)
    ...
    def make_case_Jack_3_5mm_Neutrik(self, params):
        ...
        case2 = (
            cq.Workplane("YZ")
            .workplane(offset=0.0 - (W / 2.0) - 0.1)
            .moveTo(0.0, H)
            .circle(3.5 / 2.0, False)
            .extrude(AW + 0.2)
        )
        ...
        case1 = (
            cq.Workplane("YZ")
            .workplane(offset=0.0 - (W / 2.0) - AW1)
            .moveTo(0.0, H)
            .circle(AL1 / 2.0, False)
            .extrude(AW1)
        )
        #        case = case.union(case1)
        #
        case1 = (
            cq.Workplane("YZ")
            .workplane(offset=0.0 - (W / 2.0) - (1.0 * AW1))
            .moveTo(0.0, H)
            .circle(H, False)
            .extrude(AW1)
        )
        ...
        for i in range(0, 4):
            case1 = (
                cq.Workplane("YZ")
                .workplane(offset=tx - dx1)
                .moveTo(0.0, H)
                .circle(AL2 / 2.0, False)
                .extrude(AW2)
            )
            if i == 1 or i == 2:
                ...
                case2 = (
                    ...
                    .moveTo(tx - dx1, (AL2 / 2.0))
                    .rect(3.0 * AW2, 2.0 * AW2)
                    .extrude(2.0 * H)
                )
                case1 = case1.cut(case2)
                case2 = (
            ...
            if i == 3:
                ...
                case2 = (
                    cq.Workplane("XY")
                    .workplane(offset=H + (AL2 / 2.0) - 1.0)
                    .moveTo(tx - dx1, 0.0)
                    .rect(3.0 * AW2, 6.0 * AW2)
                    .extrude(AW2)
                )
                case1 = case1.cut(case2)
            case = case.union(case1)
        ...
        case1 = (
            cq.Workplane("YZ")
            .workplane(offset=0.0 - (W / 2.0) - 5.0)
            .moveTo(0.0, H)
            .circle(3.5 / 2.0, False)
            .extrude(AW + 5.2)
        )
    ...
    def make_pin(self, params):
        ...
        for n in pin:
            ...
            if t == "rect":
                ...
                case2 = (
                    cq.Workplane("XY")
                    .workplane(offset=(lt - ttf - l))
                    .moveTo(0.0, 0.0 - ((2.0 * ttf) - (l / 2.0)))
                    .rect(2.0 * w, ttl)
                    .extrude(l)
                )
                case1 = case1.union(case2)
