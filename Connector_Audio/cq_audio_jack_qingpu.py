...
class cq_audio_jack_qingpu:
    ...
    def make_top_type(self, params):
        ...
        if BT == 1:
            case = (
                cq.Workplane("YZ")
                .workplane(offset=AX - AW)
                .moveTo(AY, AZ)
                .circle(AL1 / 2.0 + 0.2, False)
                .extrude(AW)
            )
            case1 = (
                cq.Workplane("YZ")
            ...
            case = (
                cq.Workplane("XZ")
                .workplane(offset=0.0 - ((L / 2.0) + AW + AY))
                .moveTo(AX, AZ)
                .circle(AL1 / 2.0 + 0.2, False)
                .extrude(AW)
            )
            ...
            case1 = (
                cq.Workplane("XY")
                .workplane(offset=H - 0.1)
                .moveTo(0.0, (L / 2.0) - 2.0)
                .rect(W + 0.1, 3.0)
                .extrude(0.2)
            )
            case2 = (
                cq.Workplane("XY")
                .workplane(offset=0.8 + 0.1)
                .moveTo((W / 2.0), (L / 2.0) - 2.0)
                .rect(0.2, 3.0)
                .extrude(H - 0.8)
            )
            ...
            case1 = (
                cq.Workplane("XY")
                .workplane(offset=AZ + AL)
                .moveTo(0.0, 0.0)
                .circle(AW / 2.0 - 0.2, False)
                .extrude(AL1)
            )
            ...
            case1 = (
                cq.Workplane("XY")
                .workplane(offset=AZ + AL + AL1 + 0.1)
                .moveTo(0.0, 0.0)
                .circle(AW1 / 2.0, False)
                .extrude(0.0 - (AZ + AL + AL1 + 0.2))
            )
            case = case.cut(case1)
    ...
    def make_case_type(self, params):
        ...
        if BT == 1:
            ...
            case3 = (
                cq.Workplane("XZ")
                .workplane(offset=0.0 - ((L / 2.0) + (AW / 2.0) + AY))
                .moveTo(AX, AZ + (H / 2.0))
                .rect(AW, AW / 2.0)
                .extrude(AW / 2.0)
            )
