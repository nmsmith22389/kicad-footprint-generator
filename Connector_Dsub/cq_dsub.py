...
class cq_dsub:
    ...
    def set_translate(self, params):
        ...
        if params["translate"] != None:
            if len(params["translate"]) != 3:
                print("\r\n")
                print(
                    "params.translate length is not 3 for model name "
                    + params["model_name"]
                    + "\r\n"
                )
                sys.exit()
    ...
    def get_dsub_size(self, params):
        ...
        if (serie == 2) and pn == 15:
            ...
            if params["gender"] == "female":
                ...
                return (25.50, 33.30, 39.20, 27.70, 8.3, 12.50, 3.2)
        #
        #
        if (serie == 3) and pn == 15:
            #             A      B      C      D     E     F     G
            if params["gender"] == "female":
                return (16.30, 25.00, 30.80, 15.80, 7.9, 12.50, 3.3)
            else:
        ...
        if (serie == 3) and pn == 26:
            #             A      B      C      D     E     F     G
            if params["gender"] == "female":
                return (24.60, 33.30, 39.20, 24.10, 7.9, 12.50, 3.2)
            else:
        ...
        if (serie == 3) and pn == 44:
            #             A      B      C      D     E     F     G
            if params["gender"] == "female":
                return (38.30, 47.10, 53.10, 37.90, 7.9, 12.50, 3.2)
            else:
        ...
        if (serie == 3) and pn == 62:
            #             A      B      C      D     E     F     G
            if params["gender"] == "female":
                return (54.80, 63.50, 69.50, 54.30, 7.9, 12.50, 3.2)
            else:
                return (55.42, 63.50, 69.40, 54.30, 8.3, 12.50, 3.2)

        print("\r\n")
        print(
            "ERROR: Model ID " + str(params["model_name"]) + " does not exist, exiting"
        )
        print("\r\n")
    ...
    def make_npth_pins(self, params):
        ...
        if ns == 2:
            ...
            case1 = (
                cq.Workplane("XY")
                .workplane(centerOption="CenterOfMass", offset=0.0 - 2.0)
                .moveTo(((C / 2.0) - 2.0), 2.5)
                .rect(7.0, F)
                .extrude(0.0 - FW)
            )
            case = case.cut(case1)
            ...
            case1 = (
                cq.Workplane("XZ")
                .workplane(centerOption="CenterOfMass", offset=(F / 2.0) + 0.5)
                .moveTo((B / 2.0), (0.0 - FW) + ttx)
                .circle((G / 2.0), False)
                .extrude(0.0 - (F + 1.0))
            )
            case = case.cut(case1)
            ...
            case1 = (
                cq.Workplane("XZ")
                .workplane(centerOption="CenterOfMass", offset=(F / 2.0) + 0.5)
                .moveTo(0.0 - (B / 2.0), (0.0 - FW) + ttx + G / 2.0)
                .circle(G / 2.0, False)
                .extrude(0.0 - (F + 1.0))
            )
            case = case.cut(case1)
            case1 = (
                cq.Workplane("XZ")
                .workplane(centerOption="CenterOfMass", offset=(F / 2.0) + 0.5)
                .moveTo(0.0 - (B / 2.0), (0.0 - FW) + ttx + G / 4.0)
                .rect(G, G / 2.0)
                .extrude(0.0 - (F + 1.0))
            )
            case = case.cut(case1)
        ...
        if params["gender"] == "female":
            ...
            if serie == 2:
                ...
                for i in range(0, np):
                    case1 = (
                        cq.Workplane("XY")
                        .workplane(centerOption="CenterOfMass", offset=8.0)
                        .moveTo(x, y)
                        .circle(pind / 1.5, False)
                        .extrude(12.0)
                    )
    ...
    def make_case_DSUB(self, params):
        ...
        case2 = (
            cq.Workplane("XY")
            .workplane(centerOption="CenterOfMass", offset=ptl + 0.1)
            .moveTo((B / 2.0), 0.0)
            .circle(G / 2.0, False)
            .extrude(0.0 - (ptl + 0.2))
        )
        ...
        try:
            ...
            try:
                case = (
                    case.faces(">Z[1]").edges("not(<X or >X or <Y or >Y)").fillet(0.6)
                )
            except:
                pass
    ...
    def make_pin_help(self, params, x, y, tddx, np, LD22):
        ...
        for i in range(0, np):
            if t == "round" or (t == "round1" and ns == 2):
                case1 = (
                    cq.Workplane("XY")
                    .workplane(centerOption="CenterOfMass", offset=0.4)
                    .moveTo(x, y)
                    .circle(pind / 2.0, False)
                    .extrude(0.0 - (pinl + 0.4))
                )
            ...
            if (t == "round" or t == "round1") and params["gender"] == "male":
                ...
                if serie == 2:
                    if t == "round1":
                        case1 = (
                            cq.Workplane("XY")
                            .workplane(centerOption="CenterOfMass", offset=4.4)
                            .moveTo(x, y - (pindy / 2.0))
                            .circle(pind / 2.0, False)
                            .extrude(pinl + 2.0)
                        )
                    else:
    ...
    def make_pin(self, params):
        ...
        if ns == 2:
            ...
            case1 = (
                cq.Workplane("XY")
                .workplane(centerOption="CenterOfMass", offset=2.5)
                .moveTo(tx, y)
                .rect(2.0, 0.2)
                .extrude(0.0 - (pinl + 4.0))
            )
            case1 = case1.faces("<Z").edges("<X").chamfer(0.8, 0.2)
            case1 = case1.faces("<Z").edges(">X").chamfer(0.2, 0.8)
            case2 = (
                cq.Workplane("XY")
                .workplane(centerOption="CenterOfMass", offset=2.3)
                .moveTo(tx, y)
                .rect(0.8, 0.2)
                .extrude(0.0 - (pinl + 4.0))
            )
            ...
            case2 = (
                ...
                .workplane(centerOption="CenterOfMass", offset=2.5)
                .moveTo(tx - 1.0, y + 0.1)
                .rect(2.0, 0.0 - tyr, centered=False)
                .extrude(0.2)
            )
            ...
            case2 = (
                cq.Workplane("XY")
                .workplane(centerOption="CenterOfMass", offset=2.5)
                .moveTo(tx - 1.0, y + 0.1 - tyr)
                .rect(2.0, 0.2, centered=False)
                .extrude(2.1)
            )
            case1 = case1.union(case2)
    ...
    all_params = {
        ...
        "DSUB_3": Params(
            ...
            pin=[
                ...
                0.64,
                3.9,
            ],  # Type of pins, type, #pin, x, y, diam, length under pcb, *length above pcb, length form hole), last two is for 90 degree bended
            serie=2,  # Shape
