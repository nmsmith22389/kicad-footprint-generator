...
def make_models(model_to_build=None, output_dir_prefix=None, enable_vrml=True):
    ...
    for model in models:
        ...
        pins = pins.translate((-all_params[model]['F'] / 2.0, 0, 0)).rotate((0, 0, 0), (0, 0, 1), 180)
        ...
        if enable_vrml:
            export_VRML(os.path.join(output_dir, file_name + ".wrl"), [body, base, mark, pins, top], [all_params[model]["body_color_key"], all_params[model]["base_color_key"], all_params[model]["mark_color_key"], all_params[model]["pin_color_key"], all_params[model]["top_color_key"]])
