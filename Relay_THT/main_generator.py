...
from .relay_tht import make_case, make_case_top, make_pins_smd, make_pins_tht, make_pins_tht_n
...
def make_models(model_to_build=None, output_dir_prefix=None, enable_vrml=True):
    ...
    for model in models:
        ...
        if enable_vrml:
            export_VRML(os.path.join(output_dir, file_name + ".wrl"), [body, body_top, pins], [all_params[model]["body_color_key"], all_params[model]["body_top_color_key"], all_params[model]["pin_color_key"]])
