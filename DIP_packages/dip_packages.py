...
def make_case(params):
    ...
    if ef != 0:
        case = case.edges(
            BS((D_t2 / 2.0 + 0.1, E1_t2 / 2.0, 0), (D / 2.0 + 0.1, E1 / 2.0 + 0.1, A2))
        ).fillet(ef)
        case = case.edges(
            BS((-D_t2 / 2.0, E1_t2 / 2.0, 0), (-D / 2.0 - 0.1, E1 / 2.0 + 0.1, A2))
        ).fillet(ef)
        case = case.edges(
            BS((-D_t2 / 2.0, -E1_t2 / 2.0, 0), (-D / 2.0 - 0.1, -E1 / 2.0 - 0.1, A2))
        ).fillet(ef)
        ...
        case = case.edges(
            BS((D / 2.0, E1 / 2.0, A - ti_d - 0.001), (-D / 2.0, -E1 / 2.0, A + 0.1))
        ).fillet(ef)
    ## else:
