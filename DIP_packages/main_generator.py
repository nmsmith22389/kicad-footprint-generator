...
__author__ = "scripts: maurice, hyOzd, Stefan; models: see cq_model files; update: jmwright"
...
def make_models(model_to_build=None, output_dir_prefix=None, enable_vrml=True):
    ...
    for model in models:
        ...
        pins = pins.rotate((0, 0, 0), (0, 0, 1), all_params[model]['rotation']).translate ((mvX,-mvY,0))
