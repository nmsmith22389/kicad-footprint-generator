...
def make_models(model_to_build=None, output_dir_prefix=None, enable_vrml=True):
    ...
    for model in models:
        ...
        pig_color = shaderColors.named_colors[all_params[model]["pig_color_key"]].getDiffuseFloat()
        ...
        component.add(pigs, color=cq_color_correct.Color(pig_color[0], pig_color[1], pig_color[2]))
        ...
        if enable_vrml:
            export_VRML(os.path.join(output_dir, file_name + ".wrl"), [body, pins, pigs], [all_params[model]["body_color_key"], all_params[model]["pin_color_key"], all_params[model]["pig_color_key"]])
