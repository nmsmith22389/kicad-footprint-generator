...
__Comment__ = (
    "make DIP switch 3D models exported to STEP and VRML for Kicad StepUP script"
)
...
all_params = {
    ...
    "SW_DIP_x1_W5.08mm_Slide_Copal_CHS-A": make_params(
        5.08,
        2.54,
        2.5,
        0.00,
        ...
        0.76,
        0,
        "SW_DIP_x1_W5.08mm_Slide_Copal_CHS-A",
        0,
        CASE_SMD_TYPE,
        CORNER_CHAMFER_TYPE,
    ),
    "SW_DIP_x1_W7.62mm_Slide_Copal_CHS-B": make_params(
        5.00,
        2.54,
        2.5,
        0.00,
        ...
        0.76,
        1,
        "SW_DIP_x1_W7.62mm_Slide_Copal_CHS-B",
        0,
        CASE_SMD_TYPE,
        CORNER_CHAMFER_TYPE,
    ),
    "SW_DIP_x1_W8.61mm_Slide_LowProfile": make_params(
        5.00,
        4.10,
        1.5,
        0.00,
    ...
    "SW_SPST_REED_CT05-XXXX-G1": make_params(
        6.40,
        3.50,
        2.30,
        0.00,
    ...
    "SW_SPST_REED_CT05-XXXX-J1": make_params(
        6.40,
        3.50,
        2.30,
        0.00,
    ...
    "SW_SPST_REED_CT10-XXXX-G1": make_params(
        11.6,
        2.40,
        2.30,
        0.00,
    ...
    "SW_SPST_REED_CT10-XXXX-G2": make_params(
        11.6,
        2.40,
        2.30,
        0.00,
    ...
    "SW_SPST_REED_CT10-XXXX-G4": make_params(
        11.6,
        2.40,
        2.30,
        0.00,
    ...
    "SW_DIP_x2_W5.08mm_Slide_Copal_CHS-A": make_params(
        5.40,
        3.81,
        2.5,
        1.27,
        ...
        0.76,
        0,
        "SW_DIP_x2_W5.08mm_Slide_Copal_CHS-A",
        0,
        CASE_SMD_TYPE,
        CORNER_CHAMFER_TYPE,
    ),
    "SW_DIP_x2_W6.15mm_Slide_Omron_A6H": make_params(
        4.50,
        3.81,
        2.5,
        1.27,
        ...
        0.76,
        1,
        "SW_DIP_x2_W6.15mm_Slide_Omron_A6H",
        0,
        CASE_SMD_TYPE,
        CORNER_CHAMFER_TYPE,
    ),
    "SW_DIP_x2_W7.62mm_Slide_Copal_CHS-B": make_params(
        5.40,
        3.81,
        2.5,
        1.27,
        ...
        0.75,
        1,
        "SW_DIP_x2_W7.62mm_Slide_Copal_CHS-B",
        0,
        CASE_SMD_TYPE,
        CORNER_CHAMFER_TYPE,
    ),
    "SW_DIP_x2_W8.61mm_Slide_LowProfile": make_params(
        6.68,
        6.64,
        1.5,
        2.54,
    ...
    "SW_DIP_x3_W8.61mm_Slide_LowProfile": make_params(
        6.68,
        9.18,
        1.5,
        2.54,
    ...
    "SW_DIP_x4_W5.08mm_Slide_Copal_CHS-A": make_params(
        5.40,
        6.35,
        2.5,
        1.27,
        ...
        0.75,
        0,
        "SW_DIP_x4_W5.08mm_Slide_Copal_CHS-A",
        0,
        CASE_SMD_TYPE,
        CORNER_CHAMFER_TYPE,
    ),
    "SW_DIP_x4_W6.15mm_Slide_Omron_A6H": make_params(
        4.50,
        6.35,
        2.5,
        1.27,
        ...
        0.75,
        1,
        "SW_DIP_x4_W6.15mm_Slide_Omron_A6H",
        0,
        CASE_SMD_TYPE,
        CORNER_CHAMFER_TYPE,
    ),
    "SW_DIP_x4_W7.62mm_Slide_Copal_CHS-B": make_params(
        5.40,
        6.35,
        2.5,
        1.27,
        ...
        0.75,
        1,
        "SW_DIP_x4_W7.62mm_Slide_Copal_CHS-B",
        0,
        CASE_SMD_TYPE,
        CORNER_CHAMFER_TYPE,
    ),
    "SW_DIP_x4_W8.61mm_Slide_LowProfile": make_params(
        6.68,
        11.72,
        1.5,
        2.54,
    ...
    "SW_DIP_x5_W8.61mm_Slide_LowProfile": make_params(
        6.68,
        14.26,
        2.5,
        2.54,
    ...
    "SW_DIP_x6_W5.08mm_Slide_Copal_CHS-A": make_params(
        5.40,
        8.89,
        2.5,
        1.27,
        ...
        0.75,
        0,
        "SW_DIP_x6_W5.08mm_Slide_Copal_CHS-A",
        0,
        CASE_SMD_TYPE,
        CORNER_CHAMFER_TYPE,
    ),
    "SW_DIP_x6_W6.15mm_Slide_Omron_A6H": make_params(
        4.50,
        8.89,
        2.5,
        1.27,
        ...
        0.75,
        1,
        "SW_DIP_x6_W6.15mm_Slide_Omron_A6H",
        0,
        CASE_SMD_TYPE,
        CORNER_CHAMFER_TYPE,
    ),
    "SW_DIP_x6_W7.62mm_Slide_Copal_CHS-B": make_params(
        5.40,
        8.89,
        2.5,
        1.27,
        ...
        0.75,
        1,
        "SW_DIP_x6_W7.62mm_Slide_Copal_CHS-B",
        0,
        CASE_SMD_TYPE,
        CORNER_CHAMFER_TYPE,
    ),
    "SW_DIP_x6_W8.61mm_Slide_LowProfile": make_params(
        6.68,
        16.80,
        1.5,
        2.54,
    ...
    "SW_DIP_x7_W8.61mm_Slide_LowProfile": make_params(
        6.68,
        19.34,
        1.5,
        2.54,
    ...
    "SW_DIP_x8_W5.08mm_Slide_Copal_CHS-A": make_params(
        5.30,
        11.43,
        2.5,
        1.27,
        ...
        0.75,
        0,
        "SW_DIP_x8_W5.08mm_Slide_Copal_CHS-A",
        0,
        CASE_SMD_TYPE,
        CORNER_CHAMFER_TYPE,
    ),
    "SW_DIP_x8_W6.15mm_Slide_Omron_A6H": make_params(
        4.50,
        11.43,
        2.5,
        1.27,
        ...
        0.75,
        1,
        "SW_DIP_x8_W6.15mm_Slide_Omron_A6H",
        0,
        CASE_SMD_TYPE,
        CORNER_CHAMFER_TYPE,
    ),
    "SW_DIP_x8_W7.62mm_Slide_Copal_CHS-B": make_params(
        5.40,
        11.43,
        2.5,
        1.27,
        ...
        0.75,
        1,
        "SW_DIP_x8_W7.62mm_Slide_Copal_CHS-B",
        0,
        CASE_SMD_TYPE,
        CORNER_CHAMFER_TYPE,
    ),
    "SW_DIP_x8_W8.61mm_Slide_LowProfile": make_params(
        6.68,
        21.88,
        1.5,
        2.54,
    ...
    "SW_DIP_x9_W8.61mm_Slide_LowProfile": make_params(
        6.68,
        24.42,
        1.5,
        2.54,
    ...
    "SW_DIP_x10_W5.08mm_Slide_Copal_CHS-A": make_params(
        5.30,
        13.97,
        2.5,
        1.27,
        ...
        0.75,
        0,
        "SW_DIP_x10_W5.08mm_Slide_Copal_CHS-A",
        0,
        CASE_SMD_TYPE,
        CORNER_CHAMFER_TYPE,
    ),
    "SW_DIP_x10_W6.15mm_Slide_Omron_A6H": make_params(
        4.50,
        13.97,
        2.5,
        1.27,
        ...
        0.75,
        1,
        "SW_DIP_x10_W6.15mm_Slide_Omron_A6H",
        0,
        CASE_SMD_TYPE,
        CORNER_CHAMFER_TYPE,
    ),
    "SW_DIP_x10_W7.62mm_Slide_Copal_CHS-B": make_params(
        5.40,
        13.97,
        2.5,
        1.27,
        ...
        0.75,
        1,
        "SW_DIP_x10_W7.62mm_Slide_Copal_CHS-B",
        0,
        CASE_SMD_TYPE,
        CORNER_CHAMFER_TYPE,
    ),
    "SW_DIP_x10_W8.61mm_Slide_LowProfile": make_params(
        6.68,
        26.99,
        1.5,
        2.54,
    ...
    "SW_DIP_x11_W8.61mm_Slide_LowProfile": make_params(
        6.68,
        29.50,
        1.5,
        2.54,
    ...
    "SW_DIP_x12_W8.61mm_Slide_LowProfile": make_params(
        6.68,
        32.04,
        1.5,
        2.54,
...
def make_case(params):
    ...
    if npins < 3:
        ...
        pighole = (
            cq.Workplane("XY")
            .workplane(offset=A1 + H)
            .moveTo(myX, myY)
            .rect(myXD, myYD, False)
            .extrude(-(H / 4))
        )
...
def make_pins_smd(params):
    ...
    pins = (
        cq.Workplane("ZY")
        .workplane(offset=-myX - padsw - (padsh / 2.0))
        .moveTo(0, myY)
        .rect(padsw, padsw, False)
        .extrude(padsh)
    )
    pin1 = (
        cq.Workplane("ZY")
    ...
    if pinshape == 0:
        ...
        pint = (
            cq.Workplane("XY")
            .workplane(offset=padsw - padsh)
            .moveTo(myX, myY)
            .rect(-myX, padsw, False)
            .extrude(padsh)
        )
...
def make_3D_model(models_dir, variant):
    ...
    CheckedmodelName = (
        modelName.replace(".", "").replace("-", "_").replace("(", "").replace(")", "")
    )
    ...
    FuseObjs_wColors(
        FreeCAD, FreeCADGui, doc.Name, objs[0].Name, objs[1].Name, objs[2].Name
    )
    ...
    expVRML.writeVRMLFile(
        colored_meshes, export_file_name, used_color_keys, LIST_license
    )
    # scale=0.3937001
    # exportVRML(doc,modelName,scale,out_dir)
...
if __name__ == "__main__" or __name__ == "main_generator":
    ...
    if len(sys.argv) < 3:
        FreeCAD.Console.PrintMessage(
            "No variant name is given! building SW_DIP_x2_W5.08mm_Slide_Copal_CHS-A\r\n"
        )
    ...
    for variant in variants:
        ...
        if not variant in all_params:
            print(
                "Parameters for %s doesn't exist in 'all_params', skipping. " % variant
            )
            continue
