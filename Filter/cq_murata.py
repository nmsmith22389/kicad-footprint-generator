...
class cq_murata():
    ...
    def make_pin(self, params):
        ...
        if serie == 'SAFEA':
            ...
            # Make dummy
            #
            case = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=0.1).moveTo(0.0, 0.0).circle(0.01).extrude(0.01)
        elif serie == 'SAFFB':
            case = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=-0.005).moveTo(-0.385, 0.0).rect(0.18, 0.25).extrude(0.1)
            case1 = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=-0.005).moveTo(0.0, 0.0 - 0.25).rect(0.18, 0.25).extrude(0.1)
            case = case.union(case1)
            case1 = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=-0.005).moveTo(0.25, 0.0 - 0.25).rect(0.18, 0.25).extrude(0.1)
            case = case.union(case1)
            case1 = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=-0.005).moveTo(0.25, 0.25).rect(0.18, 0.25).extrude(0.1)
            case = case.union(case1)
            case1 = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=-0.005).moveTo(0.0, 0.25).rect(0.18, 0.25).extrude(0.1)
            case = case.union(case1)
        elif serie == 'SAWEN':
            #
            # Make dummy
    ...
    def make_npth_pin(self, params):
        ...
        # Make dummy
        #
        case = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=0.0).moveTo(0.0, 0.0).rect(W, L).extrude(H1+0.325)
        case = case.faces("<X").edges("<Y").fillet(0.03)
        case = case.faces("<X").edges(">Y").fillet(0.03)
        case = case.faces(">X").edges("<Y").fillet(0.03)
        case = case.faces(">X").edges(">Y").fillet(0.03)
