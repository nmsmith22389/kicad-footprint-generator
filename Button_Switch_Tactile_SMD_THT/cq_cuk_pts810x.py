...
from .cq_cuk_kmr2x import TactSwitchSeries, cqMakerCuK_Kmr2xTactSwitch, parts_cuk_kmr2
...
class cqMakerCuK_PTS810xTactSwitch(cqMakerCuK_Kmr2xTactSwitch):
    ...
    def makeCoverPlate(self):
        ...
        body = body.translate((0.0, 0.0, self.cover_offset)).cut(
            self.makeButton(self.button_oval_length + 0.1, self.button_oval_width + 0.1)
        )
