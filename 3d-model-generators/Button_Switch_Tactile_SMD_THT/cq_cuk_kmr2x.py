...
from .cq_base_tact_switches import (
    TactSwitchSeries,
    cqMakerTactSwitch,
    partsTactSwitches,
)
...
from .cq_parameters import ButtonType, ShapeOfTerminal, partParamsTactSwitches
...
class cqMakerCuK_Kmr2xTactSwitch(cqMakerTactSwitch):
    ...
    def __init__(self, parameter):
        ...
        self.button_oval_width = (
            parameter["button_oval_width"]
            if parameter["button_oval_width"] != None
            else 2.11
        )
        self.button_oval_length = (
            parameter["button_oval_length"]
            if parameter["button_oval_length"] != None
            else 1.61
        )
        ...
        pad = (
            cq.Workplane(
                ...
                origin=(
                    ...
                    self.body_height - self.cover_thickness - self.pad_side_height,
                ),
            )
            ...
            .edges(">Z")
            .edges(">Y")
            .fillet(self.pad_side_width * 0.99)
        )
    ...
    def makePlasticCase(self):
        ...
        body = (
            cq.Workplane("XY")
            .rect(self.body_length, self.body_width - 2.0 * self.pad_side_width)
            .extrude(self.body_height - self.cover_thickness)
        )
        ...
        if self.with_gnd_pin:
            pocket = (
                cq.Workplane("YZ")
                .rect(self.gnd_pin_width * 1.1, 2.0 * self.body_height)
                .extrude(self.cover_thickness * 2.0)
    ...
    def _coverSideSheetsClosed(self):
        ...
        body = (
            ...
            .edges(">Z")
            .edges("<Y")
            .fillet(2.0 * self.cover_thickness * 0.8)
        )
    ...
    def _makeGndPin(self, pin_width=None, pin_thickness=None):
        ...
        gndPin = (
            cq.Workplane("YZ")
            .rect(self.gnd_pin_width, self.body_height)
    ...
    def makeCoverPlate(self):
        ...
        body = (
            body.translate((0.0, 0.0, self.body_height - self.cover_thickness))
            .union(self._coverSideSheetsClosed())
            .cut(
                self.makeButton(
                    self.button_oval_length + 0.1, self.button_oval_width + 0.1
                )
            )
        )
        ...
        if self.with_gnd_pin:
            pocket = (
                cq.Workplane("YZ")
                .rect(self.gnd_pin_width * 1.6, self.body_height)
                .extrude(self.cover_thickness * 2.0)
                .translate(
                    (
                        self.body_length / 2.0 - self.cover_thickness,
