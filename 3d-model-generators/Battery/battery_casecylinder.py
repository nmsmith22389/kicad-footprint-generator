...
def make_case_Cylinder1(params):
    ...
    case1 = (
        cq.Workplane("YZ")
        .workplane(offset=x21)
        .moveTo(y2, z2)
        .circle(cellD / 2.0, False)
        .extrude(sls)
    )
    ...
    if BS[0] == "round":
        ...
        case1 = (
            cq.Workplane("XY")
            .workplane(offset=A1 + A11 + h2 - 0.1)
            .moveTo(0.0 - (L / 2.0), y2)
            .rect(dx3, rx, centered=False)
            .extrude((cellD / 2.0) + 0.1)
        )
        case = case.union(case1)
        #
        dx8 = 2.0
    ...
    case1 = (
        cq.Workplane("XY")
        .workplane(offset=A1 + A11 + H - 0.01)
        .moveTo(0.0, 0.0)
        .rect(L + 2.0, W + 2.0)
        .extrude(2.0 * H)
    )
