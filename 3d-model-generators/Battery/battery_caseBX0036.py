...
def make_case_BX0036(params):
    ...
    pins = params[
        "pins"
    ]  # Pins tht/smd, x pos, y pos, 'round/rect', diameter/x size, y size, length
    ...
    case1 = (
        ...
        .moveTo((L / 2.0) - 3.0, 0.0 - ((W / 2.0) - 1.5))
        .rect(6, 3.0)
        .extrude(H)
    )
    ...
    if cellsize == "C":
        case1 = (
            cq.Workplane("YZ")
            .workplane(offset=tx - 25.0)
            .moveTo(0.0, (H / 2.0) + 3.0)
            .circle(26.2 / 2.0, False)
            .extrude(50.0)
        )
        case = case.cut(case1)
