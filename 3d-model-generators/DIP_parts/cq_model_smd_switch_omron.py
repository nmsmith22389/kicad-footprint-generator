...
class dip_switch_omron_a6h(dip_smd_switch_lowprofile):
    ...
    def makeModelName(self, genericName):
        if self.num_pins == 10:
            return (
                ...
                + "_Slide_Omron_A6H-0101_W6.15mm_P"
            ...
            return (
                ...
                + "{:02d}".format(int(self.num_pins / 2))
                + "_Slide_Omron_A6H-"
                + "{:01d}".format(int(self.num_pins / 2))
                + "101_W6.15mm_P"
                + "{:.2f}".format(self.pin_pitch)
                + "mm"
            )
    ...
    def _make_cornerpockets(self):
        ...
        pocket = (
            cq.Workplane(
                "XY",
                origin=(
                    self.body_length / 2 - 0.5,
                    self.body_width / 2.0 - 0.25,
                    self.body_height,
                ),
            )
            .rect(width, width)
    ...
    def make_body(self):
        body = (
            super(dip_switch_omron_a6h, self)
            .make_body(0.2, 0.0)
    ...
    def make_buttons(self):
        ...
        button = (
            ...
            .extrude(self.button_heigth + 0.11)
        )
