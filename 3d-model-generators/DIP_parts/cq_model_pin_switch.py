...
class dip_switch(PartBase):
    ...
    def __init__(self, params):
        ...
        self.first_pin_pos = (
            ...
            (self.pin_rows_distance / 2.0) - self.pin_thickness,
        )
        self.offsets = (
            (self.body_length / 2.0) - 1.8 - self.pin_width,
    ...
    def make_body(self):
        ...
        body.faces("<Z").rect(self.body_length - 1.0, self.body_width).cutBlind(
            self.body_board_pad_height
        )
        body.faces("<Z").rect(self.body_length, self.body_width - 3.0).cutBlind(
            self.body_board_pad_height
        )
        ...
        pin = (
            cq.Workplane(
                ...
                (
                    ...
                    self.pin_rows_distance / 2.0 + self.pin_thickness / 2.0,
                    self.body_board_pad_height,
                ),
            )
...
class dip_switch_low_profile(dip_switch):
    ...
    def __init__(self, params):
        ...
        self.offsets = (
            (self.body_length / 2.0) - 1.5 - self.pin_width,
            self.pin_rows_distance / 2.0,
            self.body_board_distance,
        )
