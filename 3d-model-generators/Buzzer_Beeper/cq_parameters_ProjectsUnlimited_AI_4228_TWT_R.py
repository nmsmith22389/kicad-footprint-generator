...
class cq_parameters_ProjectsUnlimited_AI_4228_TWT_R:
    ...
    def make_case(self, params):
        ...
        case1 = (
            cq.Workplane("XY")
            .workplane(offset=A1 + 3.0)
            .moveTo(x, y)
            .circle(d1 - 13.0, False)
            .extrude(H - 3.0)
        )
        case1 = case1.faces(">Z").edges(">Y").fillet(0.48)
        case = case.union(case1)
        ...
        case1 = (
            cq.Workplane("XY")
            .workplane(offset=A1 + H - 0.2)
            .moveTo((x - (D / 2.0)) + 2.5, 0)
            .rect(2.0, 0.5)
            .extrude(0.4)
        )
        case = case.cut(case1)
