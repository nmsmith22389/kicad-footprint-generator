...
def generate_straight_pins(params):
    ...
    locked_pin = (
        cq.Workplane("YZ")
        .workplane(-pin_width / 2, centerOption="CenterOfMass")
        .move(-pin_width / 2, -pin_depth)
        .polyline(pl, includeCurrent=True)
        .close()
        .extrude(pin_width)
    )
    ...
    normal_pin = (
        ...
        .workplane(-pin_width / 2, centerOption="CenterOfMass")
        .move(-pin_width / 2, -pin_depth)
        .polyline(pli, includeCurrent=True)
        .close()
        .extrude(pin_width)
    )
...
def generate_angled_pins(params):
    ...
    locked_pin = locked_pin.faces(">Z").edges("<Y").fillet(pin_bend_radius + pin_width)
    ...
    normal_pin = normal_pin.faces(">Z").edges("<Y").fillet(pin_bend_radius + pin_width)
...
def generate_angled_body(params):
    ...
    body_corner_y = params["body_corner_y"]
    body_front_cutout_from_side = params["body_front_cutout_from_side"]
    body_front_cutout_from_top = params["body_front_cutout_from_top"]
    body_front_cutout_width = params["body_front_cutout_width"]
    body_front_width = params["body_front_width"]
    ...
    cutout2 = (
        cq.Workplane("XZ")
        .workplane(offset=-body_corner_y, centerOption="CenterOfMass")
        .moveTo(
            body_corner_x + body_front_cutout_from_side,
        ...
        .close()
        .extrude(-body_front_width, False)
    )
    ...
    cutout3 = (
        ...
        .workplane(offset=-body_corner_y, centerOption="CenterOfMass")
        .moveTo(
            body_corner_x + body_length - body_front_cutout_from_side,
            body_height - body_front_cutout_from_top,
        )
        .vLineTo(0)
        .hLine(-body_front_cutout_width)
    ...
    fin = (
        cq.Workplane("YZ")
        .workplane(offset=body_corner_x, centerOption="CenterOfMass")
        .moveTo(d, zdistance)
        .vLine(body_fin_height)
        .line(-body_fin_length, -body_fin_height + body_fin_back_height)
        .vLineTo(0)
        .hLine(body_fin_length + body_height)
        .vLine(zdistance)
        .close()
        .extrude(body_fin_width)
    )
    body = body.union(fin)
...
def generate_straight_body(params):
    ...
    body_length = params["body_length"]
    body_front_width = params["body_front_width"]
    body_back_width = params["body_back_width"]
    body_corner_x = params["body_corner_x"]
    body_corner_y = params["body_corner_y"]
    body_side_width = params["body_side_width"]
    body_front_main_cutout_to_side = params["body_front_main_cutout_to_side"]
    body_front_main_cutout_depth = params["body_front_main_cutout_depth"]
    body_front_cutout_from_side = params["body_front_cutout_from_side"]
    body_front_cutout_from_top = params["body_front_cutout_from_top"]
    body_front_cutout_height = params["body_front_cutout_height"]
    body_front_cutout_width = params["body_front_cutout_width"]
    pin_pitch = params["pin_pitch"]
    body_plug_depth = 4.2
    ...
    body = (
        body.faces(">Z")
        .workplane(centerOption="CenterOfMass")
        .move(0, body_off_center_y)
        .rect(
            body_length - 2 * body_side_width,
            body_width - body_front_width - body_back_width,
        )
    ...
    body = (
        ...
        .line(0, body_side_cutout_depth - body_side_cutout_width / 2)
        .close()
        .cutThruAll()
    )
    ...
    bottom_cutout = (
        cq.Workplane("YZ")
        .workplane(offset=-bottom_cutout_width / 2, centerOption="CenterOfMass")
        .moveTo(body_corner_y, 0)
        .vLine(bottom_cutout_depth)
        .lineTo(-bottom_cutout_platou_len / 2.0, bottom_cutout_platou_depth)
        .line(bottom_cutout_platou_len, 0)
        .lineTo((body_width + body_corner_y), bottom_cutout_depth)
        .vLineTo(0)
        .close()
        .extrude(bottom_cutout_width)
    )
    ...
    body_back_prodrucion = (
        cq.Workplane("XY")
        .workplane(offset=body_height - body_plug_depth, centerOption="CenterOfMass")
        .moveTo(
            pin_pitch / 2.0,
            body_corner_y
            + body_width
            - body_back_width
            - body_back_prodrucion_depth / 2.0,
        )
    ...
    body_pin1_prodrucion = (
        cq.Workplane("XY")
        .workplane(
            offset=body_height - body_front_cutout_from_top, centerOption="CenterOfMass"
        )
        .moveTo(
            body_corner_x
            + body_length
            - body_front_cutout_width
            - body_pin1_prodrucion_width / 2.0,
    ...
    body = body.translate((0, -body_width / 3.0 - body_side_width, 0))
