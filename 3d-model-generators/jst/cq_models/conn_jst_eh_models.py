...
def generate_straight_body(params):
    ...
    depression = (
        cq.Workplane("YZ")
        .workplane(
            offset=-body_side_to_pin + body_side_width, centerOption="CenterOfMass"
        )
        .moveTo(
            body_corner_y,
            body_height - body_plug_depth - body_front_bottom_depression_depth,
        )
        .line(body_front_bottom_depression_width, 0)
        .line(body_front_bottom_depression_depth, body_front_bottom_depression_depth)
        .line(
            -body_front_bottom_depression_width - body_front_bottom_depression_depth, 0
        )
        .close()
        .extrude(body_length - 2 * body_side_width)
    )
