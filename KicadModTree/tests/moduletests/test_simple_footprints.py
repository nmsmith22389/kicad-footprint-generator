...
RESULT_SIMPLE_FOOTPRINT = """(footprint test (version 20221018) (generator kicad-footprint-generator)
  (layer F.Cu)
  (descr "A example footprint")
  (tags example)
  (attr smd)
  ...
  (fp_line (start -2 2) (end 5 2)
    (stroke (width 0.12) (type solid)) (layer F.SilkS))
  (fp_line (start 5 2) (end 5 -2)
    (stroke (width 0.12) (type solid)) (layer F.SilkS))
  (fp_line (start 5 -2) (end -2 -2)
    (stroke (width 0.12) (type solid)) (layer F.SilkS))
  (fp_line (start -2.25 -2.25) (end -2.25 2.25)
    (stroke (width 0.05) (type solid)) (layer F.CrtYd))
  (fp_line (start -2.25 2.25) (end 5.25 2.25)
    (stroke (width 0.05) (type solid)) (layer F.CrtYd))
  (fp_line (start 5.25 2.25) (end 5.25 -2.25)
    (stroke (width 0.05) (type solid)) (layer F.CrtYd))
  (fp_line (start 5.25 -2.25) (end -2.25 -2.25)
    (stroke (width 0.05) (type solid)) (layer F.CrtYd))
