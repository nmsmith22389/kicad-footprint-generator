...
class Node(object):
    ...
    def getNormalChilds(self):
        '''
        Get all normal child nodes of this node.

        Normal nodes are those that are appended to the node by some external
        code (probably with append() or extend())
        '''
        return self._childs
    ...
    def getVirtualChilds(self):
        '''
        Get virtual child nodes of this node.

        Virtual nodes are those that are generated by the node itself.
        '''
        return []
