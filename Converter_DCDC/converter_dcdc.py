        ...
        if pt == 'rect':
            ...
            if px < 0 and (py > (0 - (W / 2.0)) and py < ((W / 2.0))):
                ...
                if px < (0 - (L / 2.0)):
                    ...
                    xD = pd
                    yD = pd
                    pint=cq.Workplane("ZY").workplane(centerOption="CenterOfMass", offset=(L / 2.0) - (ph / 2.0)).moveTo(myZ1, myY1).rect(xD, yD).extrude(ph)
                ...
                if px > (L / 2.0):
                    ...
                    xD = pd
                    yD = pd
                    pint=cq.Workplane("ZY").workplane(centerOption="CenterOfMass", offset=0 - ((L / 2.0) + (ph / 2.0))).moveTo(myZ1, myY1).rect(xD, yD).extrude(ph)
            elif py < 0:
                # top pad
                if p[1] < (W / 2.0):
                    ...
                    xD = pd
                    myX1 = px - (pd / 2.0)
                    pint=cq.Workplane("ZX").workplane(centerOption="CenterOfMass", offset=((W / 2.0) - (ph / 2.0))).moveTo(myZ1, myX1).rect(xD, yD).extrude(ph)
            else:
                # bottom pad
                if py > (W / 2.0):
