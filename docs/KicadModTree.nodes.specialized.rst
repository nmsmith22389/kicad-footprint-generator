...
To simplify the creation on footprints, we have special classes which are build onto the base nodes. special nodes are
...
KicadModTree.nodes.specialized.PolygonLine module
--------------------------------------------------

.. automodule:: KicadModTree.nodes.specialized.PolygonLine
    :members:
    :show-inheritance:
