...
class cq_parameters_Resonator_smd_type_2:
    ...
    def make_top(self, params):
        ...
        top = top.translate(
            (0.0, 0.0, A1 + of - 0.01)
        )  # Move down 0.03 to make sure they join
