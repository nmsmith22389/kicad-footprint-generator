...
class cq_SIP_3:
    ...
    def make_npth_pins_dummy(self, params):
        ...
        pin = cq.Workplane(
            "XY"
        )  # .workplane(offset=A1 + 1.0).moveTo(0.0, 0.0).circle(0.005, False).extrude(0.001)
    ...
    def make_case_SIP4_Sharp_Angled(self, params):
        ...
        case1 = (
            ...
            .moveTo(0.0 - ((W / 2.0) - 0.525), ((L / 2.0) - 2.5))
            .rect(1.05, 5.0)
            .extrude(H + 0.2)
        )
        case = case.cut(case1)
    ...
    def make_case_SIP_8(self, params):
        ...
        case1 = (
            cq.Workplane("XZ")
            .workplane(offset=((L / 2.0) + 0.1))
            .moveTo(0.0 - ((W / 2.0) - 1.5), 1.5)
            .circle(0.5, False)
            .extrude(0.0 - 0.2)
        )
        case = case.cut(case1)
    ...
    def make_case_SLA704XM(self, params):
        ...
        case1 = (
            cq.Workplane("XZ")
            .workplane(offset=0.0 - (L / 2.0) - 0.1)
            .moveTo(D1W - (W / 2.0), D1H)
            .circle(3.2 / 2.0, False)
            .extrude(2.0 * L)
        )
        case = case.cut(case1)
        ...
        case1 = (
            cq.Workplane("XZ")
            .workplane(offset=0.0 - (L / 2.0) - 0.1)
            .moveTo(((D3W - D2W) / 2.0) + D2W - (W / 2.0), D1H)
            .rect(0.6, 3.2)
            .extrude(2.0 * L)
        )
        case = case.cut(case1)
    ...
    def make_case_STK672_040_E(self, params):
        ...
        case1 = (
            cq.Workplane("XZ")
            .workplane(offset=(L / 2.0) - 0.2)
            .moveTo(0.0 - ((W / 2.0) - 2.0), 2.0)
            .circle(0.5, False)
            .extrude(0.2)
        )
        case = case.cut(case1)
    ...
    def make_case_STK672_080_E(self, params):
        ...
        case1 = (
            cq.Workplane("XZ")
            .workplane(offset=(L / 2.0) + 0.2)
            .moveTo(0.0 - ((W / 2.0) - 2.7), 12.7)
            .circle(3.6 / 2.0, False)
            .extrude(0.0 - (L + 0.4))
        )
        case = case.cut(case1)
        case1 = (
