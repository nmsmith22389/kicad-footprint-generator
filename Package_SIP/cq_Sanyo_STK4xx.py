...
class cq_Sanyo_STK4xx:
    ...
    def make_case_Sanyo_STK4xx_59_2(self, params):
        ...
        for ph in BH:
            case1 = (
                cq.Workplane("ZX")
                .workplane(offset=0.0 - L, centerOption="CenterOfMass")
                .moveTo(ph[1], ph[0])
                .circle(ph[2] / 2.0, False)
                .extrude((2.0 * L))
            )
            case = case.cut(case1)
        #
        ...
        case1 = (
            cq.Workplane("XY")
            .workplane(offset=0.0 - 1.0, centerOption="CenterOfMass")
            .moveTo(0.0, 0.0)
            .rect(4.0, L + 2.0)
            .extrude(H + 2.0)
        )
    ...
    def make_case_Sanyo_STK4xx_78_0(self, params):
        ...
        case1 = (
            cq.Workplane("XY")
            .workplane(offset=H / 2.0, centerOption="CenterOfMass")
            .moveTo(0.0 - 3.0, 0.0 - (2.0 * L))
            .rect(6.0, L * 4.0, centered=False)
            .extrude(0.0 - (H + 2.0))
        )
        case1 = case1.rotate((0, 0, 0), (0, 1, 0), 10.0)
        case1 = case1.translate((W / 2 - 0.8, 0.0, 0.0))
        ...
        case1 = (
            cq.Workplane("XY")
            .workplane(offset=H * 1.5, centerOption="CenterOfMass")
            .moveTo(0.0 + 4.5, 0.0 - (2.0 * L))
            .rect(6.0, L * 4.0, centered=False)
            .extrude(0.0 - (H + 2.0))
        )
        case1 = case1.rotate((0, 0, 0), (0, 1, 0), 0.0 - 10.0)
