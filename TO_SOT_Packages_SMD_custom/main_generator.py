...
def make_models(model_to_build=None, output_dir_prefix=None, enable_vrml=True):
    ...
    for model in models:
        ...
        for variant in all_params[model]["variants"]:
            ...
            if enable_vrml:
                export_VRML(os.path.join(output_dir, file_name + ".wrl"), [body, tab, pins], [all_params[model]["base"]["device"]["body"]["colour"], all_params[model]["base"]["device"]["tab"]["colour"], all_params[model]["base"]["device"]["pins"]["colour"]])
