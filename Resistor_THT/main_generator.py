...
__author__ = "scripts: maurice, hyOzd and grob; models: see cq_model files; update: jmwright"
...
def make_models(model_to_build=None, output_dir_prefix=None, enable_vrml=True):
    ...
    for model in models:
        ...
        if marking != None:
            component.add(marking, color=cq_color_correct.Color(mark_color[0], mark_color[1], mark_color[2]))
