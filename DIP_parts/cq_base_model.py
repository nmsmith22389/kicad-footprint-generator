...
class PartBase(object):
    ...
    def __init__(self, params):
        ...
        self.pin_thickness = (
            params["pin_thickness"] if "pin_thickness" in params else 0.2
        )
        ...
        self.pin_rows_distance = (
            ...
            if "pin_rows_distance" in params
            else self.pin_pitch
        )
        ...
        self.body_board_distance = (
            params["body_board_distance"] if "body_board_distance" in params else 0.0
        )
    ...
    def _make_plastic_body(
        ...
        return (
            ...
            .workplane(centerOption="CenterOfMass", offset=pin_area_height)
            .rect(self.body_length, self.body_width)
            .rect(D_t1, E1_t1)
