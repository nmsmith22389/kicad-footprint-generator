...
class cq_coaxial_molex():
    ...
    def make_top_SMA_Molex_73251_2200(self, params):
        ...
        case = cq.Workplane("XZ").workplane(centerOption="CenterOfMass", offset=AY1).moveTo(AX1, AZ1).circle(AW1 / 2.0 - 0.5, False).extrude(AL1)

        # cut out pin
        case1 = cq.Workplane("XZ").workplane(centerOption="CenterOfMass", offset=AY1).moveTo(AX1, AZ1).circle(0.8, False).extrude(AL1)
        case = case.cut(case1)
    ...
    def make_top_SMA_Molex_73251_1153(self, params):
        ...
        case = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=AZ1).moveTo(AX1, AY1).circle(AW1 / 2.0 - 0.5, False).extrude(AL1)

        # cut out pin
        case1 = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=AZ1).moveTo(AX1, AY1).circle(0.8, False).extrude(AL1)
        case = case.cut(case1)
    ...
    def make_top_U_FL_Molex_MCRF_73412_0110(self, params):
        ...
        case = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=AZ1).moveTo(AX1, AY1).circle((AW1 / 2.0), False).extrude(AL1)
        case = case.faces(">Z").fillet(AW1 / 2.2)

        case1 = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=AZ).moveTo(AX, AY).circle((AW / 2.0), False).extrude(AL)
        case2 = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=AZ).moveTo(AX, AY).circle((AW / 2.0) - 0.1, False).extrude(AL)
    ...
    def make_case_SMA_Molex_73251_2200(self, params):
        ...
        # cut out under body
        if BT > 0.001:
            case1 = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=0.0).moveTo(0.0, 0.0).rect(W / 2.4, 2.0 * L).extrude(0.5)
            case = case.cut(case1)
            case1 = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=0.0).moveTo(0.0, 0.2).rect( 2.0 * L, W / 2.4).extrude(0.5)
            case = case.cut(case1)
        
        case1 = cq.Workplane("XZ").workplane(centerOption="CenterOfMass", offset=AY).moveTo(AX, AZ).circle(AW / 2.0, False).extrude(AL)
        case = case.union(case1)
        
        #
        # Do the tap
        #
        case1 = cq.Workplane("XZ").workplane(centerOption="CenterOfMass", offset=AY1).moveTo(AX1, AZ1).circle(AW1 / 2.0 - 0.2, False).extrude(AL1)
        #
        # Add the taps
        #
        tt = AY1 + 0.4
...
#        while ty < (AY1 + 2.0):
            case2 = cq.Workplane("XZ").workplane(centerOption="CenterOfMass", offset=0.0).moveTo(0.0, 0.0).circle(AW1 / 2.0, False).extrude(0.2)
        ...
        if AW2 != None:
            if AW2 > 0.01:
                tl = AW1 - AW2
                case2 = cq.Workplane("XZ").workplane(centerOption="CenterOfMass", offset=AY1).moveTo(AX1 + (AW1 / 2.0), AZ1).rect(2.0 * tl, AL1).extrude(AL1)
                case1 = case1.cut(case2)
        #
        # Cut out the center
        #
        case2 = cq.Workplane("XZ").workplane(centerOption="CenterOfMass", offset=AY1).moveTo(AX1, AZ1).circle(AW1 / 2.0 - 1.0, False).extrude(AL1 + 4.0)
        case1 = case1.cut(case2)
        #
        # Add center tap
        #
        case2 = cq.Workplane("XZ").workplane(centerOption="CenterOfMass", offset=AY1).moveTo(AX1, AZ1).circle(0.8, False).extrude(AL1)
        case3 = cq.Workplane("XZ").workplane(centerOption="CenterOfMass", offset=AY1).moveTo(AX1, AZ1).circle(0.76, False).extrude(AL1)
    ...
    def make_case_SMA_Molex_73251_1153(self, params):
        ...
        # Do the tap
        #
        case1 = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=AZ1).moveTo(AX1, AY1).circle(AW1 / 2.0 - 0.2, False).extrude(AL1)
        #
        # Add the taps
        #
        tt = AY1 + 0.4
        while tt < (AY1 + AL1 - 0.4):
#        while ty < (AY1 + 2.0):
            case2 = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=0.0).moveTo(0.0, 0.0).circle(AW1 / 2.0, False).extrude(0.2)
        ...
        if AW2 != None:
            if AW2 > 0.01:
                tl = AW1 - AW2
                case2 = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=AZ1).moveTo(AX1 + (AW1 / 2.0), AY1).rect(2.0 * tl, AL1).extrude(AL1)
                case1 = case1.cut(case2)
        #
        # Cut out the center
        #
        case2 = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=AZ1).moveTo(AX1, AY1).circle(AW1 / 2.0 - 1.0, False).extrude(AL1 + 4.0)
        case1 = case1.cut(case2)
        #
        # Add center tap
        #
        case2 = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=AZ1).moveTo(AX1, AY1).circle(0.5, False).extrude(AL1)
        case3 = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=AZ1).moveTo(AX1, AY1).circle(0.2, False).extrude(AL1)
        case2 = case2.cut(case3)
        case1 = case1.union(case2)
    ...
    def make_case_U_FL_Molex_MCRF_73412_0110(self, params):
        ...
        case = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=0.0).moveTo(0.0, 0.0).rect(W, L).extrude(H)
        # cut out under body
        case1 = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=0.0).moveTo(0.0, 0.0).rect(W, L).extrude(H)
    ...
    def make_pin(self, params):
        ...
        for n in pin:
            ...
            ld = n[5]
            if t == 'round':
                case1 = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=1.0).moveTo(0.0, 0.0).circle(w, False).extrude(0.0 - (ld + 1.0))
                case1 = case1.faces("<Z").fillet(w / 2.2)
            elif t == 'rect':
                case1 = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=1.0).moveTo(0.0, 0.0).rect(w, l).extrude(0.0 - (ld + 1.0))
                if w > l:
                ...
                case1 = cq.Workplane("XY").workplane(centerOption="CenterOfMass", offset=0.0).moveTo(0.0, 0.0).rect(w, l).extrude(ld)
