...
__author__ = "scripts: Frank & Maurice & Stefan; models: see cq_model files; update: jmwright"
...
def make_models(model_to_build=None, output_dir_prefix=None, enable_vrml=True):
    ...
    for model in models:
        ...
        if enable_vrml:
            export_VRML(os.path.join(output_dir, file_name + ".wrl"), [body, pins, top, pinmark], [all_params[model]["body_color_key"], all_params[model]["pin_color_key"], all_params[model]["top_color_key"], all_params[model]["pinmark_color_key"]])
