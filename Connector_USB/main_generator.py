...
def make_models(model_to_build=None, output_dir_prefix=None, enable_vrml=True):
    ...
    for model in models:
        ...
        tongue_color = shaderColors.named_colors[all_params[model]["tongue_color_key"]].getDiffuseFloat()
        pegs_color = shaderColors.named_colors[all_params[model]["peg_color_key"]].getDiffuseFloat()
        ...
        component.add(tongue, color=cq_color_correct.Color(tongue_color[0], tongue_color[1], tongue_color[2]))
        component.add(pegs, color=cq_color_correct.Color(pegs_color[0], pegs_color[1], pegs_color[2]))
        ...
        if enable_vrml:
            export_VRML(os.path.join(output_dir, file_name + ".wrl"), [body, tongue, pegs, pins], [all_params[model]["body_color_key"], all_params[model]["tongue_color_key"], all_params[model]["peg_color_key"], all_params[model]["pin_color_key"]])
