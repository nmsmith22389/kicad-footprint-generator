...
def generate_one_footprint(global_config: GC.GlobalConfig, pins, configuration):
    ...
    poly_yd = [
        ...
        {'x': round_to_grid(body_edge['left'] - CrtYd_offset, CrtYd_grid), 'y': round_to_grid(body_edge['top'] - CrtYd_offset, CrtYd_grid)},
        {'x': round_to_grid(body_edge['right'] + CrtYd_offset, CrtYd_grid), 'y': round_to_grid(body_edge['top'] - CrtYd_offset, CrtYd_grid)},
        {'x': round_to_grid(body_edge['right'] + CrtYd_offset, CrtYd_grid), 'y': round_to_grid(body_edge['bottom'] + CrtYd_offset, CrtYd_grid)},
        {'x': round_to_grid(body_edge['left'] - CrtYd_offset, CrtYd_grid), 'y': round_to_grid(body_edge['bottom'] + CrtYd_offset, CrtYd_grid)}
    ]
    ...
    cy2 = round_to_grid(pad_size[1] + configuration['courtyard_offset']['connector'], configuration['courtyard_grid'])
