...
def generate_one_footprint(pincount, configuration):
    mpn = "B{pincount}P-SHF-1AA".format(pincount=pincount)
    ...
    kicad_mod.append(PolygoneLine(polygone=[{'x': x1,'y': 1.1},
                                {'x': x2,'y': 1.1}], layer='F.SilkS', widge=configuration['silk_line_width']))
