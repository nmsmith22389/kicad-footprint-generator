...
def generate_one_footprint(idx, pins, configuration):
    ...
    poly_yd = [
        {'x': roundG(body_edge_out['left'] - CrtYd_offset, CrtYd_grid), 'y': roundG(-2.6 - CrtYd_offset, CrtYd_grid)},
        {'x': roundG(body_edge_out['left'] - CrtYd_offset, CrtYd_grid), 'y': roundG(2.6 + CrtYd_offset, CrtYd_grid)},
        {'x': roundG(body_edge_out['right'] + CrtYd_offset, CrtYd_grid), 'y': roundG(2.6 + CrtYd_offset, CrtYd_grid)},
        {'x': roundG(body_edge_out['right'] + CrtYd_offset, CrtYd_grid), 'y': roundG(-2.6 - CrtYd_offset, CrtYd_grid)},
        {'x': roundG(body_edge_out['left'] - CrtYd_offset, CrtYd_grid), 'y': roundG(-2.6 - CrtYd_offset, CrtYd_grid)}
    ]
    ...
    ######################### Text Fields ###############################
    cy1 = roundG(body_edge_out['top'] -1 - configuration['courtyard_offset']['connector'], configuration['courtyard_grid'])
    cy2 = roundG(body_edge_out['bottom'] + 1 + configuration['courtyard_offset']['connector'], configuration['courtyard_grid'])
