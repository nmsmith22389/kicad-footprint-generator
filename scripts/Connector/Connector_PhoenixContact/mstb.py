...
def generate_one_footprint(model, params, configuration):
    ...
    kicad_mod.append(RectLine(start=roundG(crtyd_top_left, configuration['courtyard_grid']), end=roundG(crtyd_bottom_right, configuration['courtyard_grid']), layer='F.CrtYd'))
