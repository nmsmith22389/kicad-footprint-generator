...
if __name__ == '__main__':
    ...
    for c in caps:
        ...
        makeResistorRadial(seriesname=seriesname, rm=rm, w=w, h=d, ddrill=ddrill, R_POW=R_POW,
                                    ...
                                    specialtags=specialtags, classname="C", lib_name="${KICAD8_3DMODEL_DIR}/Capacitor_THT_Rectangular", script3d=scr, height3d=h3d)
    ...
    for c in caps:
        ...
        makeResistorRadial(seriesname=seriesname, rm=rm, rm2=rm2, w=w, h=d, ddrill=ddrill, R_POW=R_POW,
                                    type=type, w2=w2, x_3d=[0, 0, 0], s_3d=[1, 1, 1], has3d=1,
                                    specialfpname="", add_description=add_description, name_additions=name_additions,
                                    specialtags=specialtags, classname="C", lib_name="${KICAD8_3DMODEL_DIR}/Capacitor_THT_Rectangular", script3d=scr, height3d=10)
    ...
    for c in caps:
        ...
        makeResistorRadial(seriesname=seriesname, rm=rm, w=w, h=d, ddrill=ddrill, R_POW=R_POW,
                           type=type, w2=w2, x_3d=[0, 0, 0], s_3d=[1, 1, 1], has3d=1,
                           specialfpname="", add_description=add_description, name_additions=name_additions,
                           specialtags=specialtags, classname="C", lib_name="${KICAD8_3DMODEL_DIR}/Capacitor_THT", script3d=script3mkt)
    ...
    for rm in [7.5, 10, 12.5, 15]:
        makeResistorAxialHorizontal(seriesname=seriesname, rm=rm, rmdisp=rm, w=w, d=d, ddrill=ddrill, R_POW=R_POW,
                                    ...
                                    specialfpname="", add_description=add_description, name_additions=name_additions,
                                    specialtags=name_additions, classname="C", lib_name="${KICAD8_3DMODEL_DIR}/Capacitor_THT", script3d=scriptaxh)
    ...
    for c in caps:
        ...
        makeResistorRadial(seriesname=seriesname, rm=rm, w=d, h=d, ddrill=ddrill, R_POW=R_POW,
                           type=type, w2=w2, x_3d=[0, 0, 0], s_3d=[1, 1, 1], has3d=1,
                           specialfpname="", add_description=add_description, name_additions=name_additions,
                           specialtags=specialtags, classname="CP", lib_name="${KICAD8_3DMODEL_DIR}/Capacitor_THT", deco=deco, script3d=scripttan)
    ...
    for c in caps:
        ...
        makeResistorRadial(seriesname=seriesname, rm=rm, rm2=rm2, w=d, h=d, ddrill=ddrill, R_POW=R_POW,
                           type=type, w2=w2, x_3d=[0, 0, 0], s_3d=[1, 1, 1], has3d=1,
                           specialfpname="", add_description=add_description, name_additions=name_additions,
                           specialtags=special_tags, classname="CP", lib_name="${KICAD8_3DMODEL_DIR}/Capacitor_THT", deco=deco,
    ...
    for c in caps:
        ...
        makeResistorAxialHorizontal(seriesname=seriesname, rm=rm, rmdisp=rm, w=l, d=d, ddrill=ddrill, R_POW=R_POW,
                           ...
                           specialfpname="", add_description=add_description, name_additions=name_additions,
                           specialtags=special_tags, classname="CP", lib_name="${KICAD8_3DMODEL_DIR}/Capacitor_THT", deco=deco, script3d=scriptcpax)
