...
if __name__ == '__main__':
    ...
    makeLEDRadial(pins=pins, rm=rm, w=w, h=h, ddrill=ddrill, rin=rin, led_type=led_type, x_3d=[0, 0, 0], s_3d=[1, 1, 1], has3d=1, specialfpname="", special_info=special_info, add_description=add_description, classname=clname, lib_name=lbname,name_additions=name_additions, script3d=script3d_rv, height3d=height3d, height3d_bottom=height3d_bottom)
    ...
    makeLEDRadial(pins=pins, rm=rm, w=w, h=h, ddrill=ddrill, rin=rin, led_type=led_type, x_3d=[0, 0, 0], s_3d=[1, 1, 1], has3d=1, specialfpname="", special_info=special_info, add_description=add_description, classname=clname+"_Oval", lib_name=lbname,name_additions=name_additions, script3d=script3d_rv, height3d=height3d, height3d_bottom=height3d_bottom)
    ...
    makeLEDRadial(pins=pins, rm=rm, w=w, h=h, ddrill=ddrill, rin=rin, led_type=led_type, x_3d=[0, 0, 0], s_3d=[1, 1, 1], has3d=1, specialfpname="", special_info=special_info, add_description=add_description, classname=clname+"_Rectangular", lib_name=lbname,name_additions=name_additions, script3d=script3d_rv, height3d=height3d, height3d_bottom=height3d_bottom)
    ...
    makeLEDRadial(pins=pins, rm=rm, w=w, h=h, ddrill=ddrill, rin=rin, led_type=led_type, x_3d=[0, 0, 0], s_3d=[1, 1, 1], has3d=1, specialfpname="", special_info=special_info, add_description=add_description, classname=clname+"_SideEmitter_Rectangular", lib_name=lbname,name_additions=name_additions, script3d=script3d_rv, height3d=height3d, height3d_bottom=height3d_bottom)
    ...
    for ledypos in [1, 3, 5]:
        for offset in offsets:
            makeLEDHorizontal(ledypos=ledypos, pins=pins, rm=rm, ddrill=ddrill,dled=dled, dledout=dledout, wledback=wledback, offsetled=offset, wled=wled, led_type=led_type, x_3d=[0, 0, 0],s_3d=[1, 1, 1], has3d=1, specialfpname="", special_info=special_info,add_description=add_description,classname=clname+"_Rectangular", lib_name=lbname, name_additions=name_additions, script3d=script3d_reh, height3d=height3d)
