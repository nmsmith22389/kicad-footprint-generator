...
if __name__ == '__main__':
    ...
    makeLEDRadial(pins=pins, rm=rm, w=w, h=h, ddrill=ddrill, rin=rin, type=type, x_3d=[0, 0, 0], s_3d=[1, 1, 1], has3d=1, specialfpname="", specialtags=specialtags, add_description=add_description, classname=clname, lib_name=lbname,name_additions=name_additions, script3d=script3d_rv, height3d=height3d, height3d_bottom=height3d_bottom)
    type="oval"; pins=2; rm=2.54; rin=0; w=5.2; h=3.8; height3d=7; height3d_bottom=0; name_additions=None; specialtags=["Oval"]; add_description="http://www.kingbright.com/attachments/file/psearch/000/00/00/L-5603QBC-D(Ver.12B).pdf"
    ...
    makeLEDRadial(pins=pins, rm=rm, w=w, h=h, ddrill=ddrill, rin=rin, type=type, x_3d=[0, 0, 0], s_3d=[1, 1, 1], has3d=1, specialfpname="", specialtags=specialtags, add_description=add_description, classname=clname+"", lib_name=lbname,name_additions=name_additions, script3d=script3d_rv, height3d=height3d, height3d_bottom=height3d_bottom)
    type="box"; pins=2; rm=2.54; rin=1.8; w=3.3; h=2.4; height3d=1.4; height3d_bottom=1.6; name_additions=None; specialtags=["Round"]; add_description=""
    makeLEDRadial(pins=pins, rm=rm, w=w, h=h, ddrill=ddrill, rin=rin, type=type, x_3d=[0, 0, 0], s_3d=[1, 1, 1], has3d=1, specialfpname="", specialtags=specialtags, add_description=add_description, classname=clname+"", lib_name=lbname,name_additions=name_additions, script3d=script3d_rv, height3d=height3d, height3d_bottom=height3d_bottom)
    ...
    type="box"; pins=2; rm=2.54; rin=0; w=3.9; h=1.9; height3d=7; height3d_bottom=0; name_additions=None; specialtags=["Rectangular"]; add_description="http://www.kingbright.com/attachments/file/psearch/000/00/00/L-144GDT(Ver.14B).pdf"
    makeLEDRadial(pins=pins, rm=rm, w=w, h=h, ddrill=ddrill, rin=rin, type=type, x_3d=[0, 0, 0], s_3d=[1, 1, 1], has3d=1, specialfpname="", specialtags=specialtags, add_description=add_description, classname=clname+"_Rectangular", lib_name=lbname,name_additions=name_additions, script3d=script3d_rv, height3d=height3d, height3d_bottom=height3d_bottom)
    type="box"; pins=2; rm=2.54; rin=0; w=3; h=2;  height3d=7; height3d_bottom=0; name_additions=None; specialtags=["Rectangular"]; add_description="http://www.kingbright.com/attachments/file/psearch/000/00/00/L-169XCGDK(Ver.9B).pdf"
    makeLEDRadial(pins=pins, rm=rm, w=w, h=h, ddrill=ddrill, rin=rin, type=type, x_3d=[0, 0, 0], s_3d=[1, 1, 1], has3d=1, specialfpname="", specialtags=specialtags, add_description=add_description, classname=clname+"_Rectangular", lib_name=lbname,name_additions=name_additions, script3d=script3d_rv, height3d=height3d, height3d_bottom=height3d_bottom)
    type="box"; pins=2; rm=2.54; rin=0; w=5; h=2;  height3d=9.7; height3d_bottom=0; name_additions=None; specialtags=["Rectangular"]; add_description="http://www.kingbright.com/attachments/file/psearch/000/00/00/L-169XCGDK(Ver.9B).pdf"
    makeLEDRadial(pins=pins, rm=rm, w=w, h=h, ddrill=ddrill, rin=rin, type=type, x_3d=[0, 0, 0], s_3d=[1, 1, 1], has3d=1, specialfpname="", specialtags=specialtags, add_description=add_description, classname=clname+"_Rectangular", lib_name=lbname,name_additions=name_additions, script3d=script3d_rv, height3d=height3d, height3d_bottom=height3d_bottom)
    type="box"; pins=3; rm=2.54; rin=0; w=5; h=2;  height3d=9.7; height3d_bottom=0; name_additions=None; specialtags=["Rectangular"]; add_description="http://www.kingbright.com/attachments/file/psearch/000/00/00/L-169XCGDK(Ver.9B).pdf"
    makeLEDRadial(pins=pins, rm=rm, w=w, h=h, ddrill=ddrill, rin=rin, type=type, x_3d=[0, 0, 0], s_3d=[1, 1, 1], has3d=1, specialfpname="", specialtags=specialtags, add_description=add_description, classname=clname+"_Rectangular", lib_name=lbname,name_additions=name_additions, script3d=script3d_rv, height3d=height3d, height3d_bottom=height3d_bottom)
    type="box"; pins=2; rm=2.54; rin=0; w=5; h=5;  height3d=9.7; height3d_bottom=0; name_additions=None; specialtags=["Rectangular"]; add_description="http://www.kingbright.com/attachments/file/psearch/000/00/00/L-169XCGDK(Ver.9B).pdf"
    makeLEDRadial(pins=pins, rm=rm, w=w, h=h, ddrill=ddrill, rin=rin, type=type, x_3d=[0, 0, 0], s_3d=[1, 1, 1], has3d=1, specialfpname="", specialtags=specialtags, add_description=add_description, classname=clname+"_Rectangular", lib_name=lbname,name_additions=name_additions, script3d=script3d_rv, height3d=height3d, height3d_bottom=height3d_bottom)
    ...
    for ledypos in [2,6,10]:
        for offset in offsets:
            makeLEDHorizontal(ledypos=ledypos, pins=pins, rm=rm, ddrill=ddrill,dled=dled, dledout=dledout, offsetled=offset, wled=wled, type=type, x_3d=[0, 0, 0],s_3d=[1, 1, 1], has3d=1, specialfpname="", specialtags=specialtags,add_description=add_description,classname=clname, lib_name=lbname, name_additions=name_additions, script3d=script3d_rh, height3d=height3d)
    type="round"; pins=2; rm=2.54; dled=5; dledout=5.8; offset=2.54;wled=8.6; height3d=5; name_additions=None; specialtags=None; add_description=""
    for ledypos in [3,9,15]:
        for offset in offsets:
            makeLEDHorizontal(ledypos=ledypos, pins=pins, rm=rm, ddrill=ddrill,dled=dled, dledout=dledout, offsetled=offset, wled=wled, type=type, x_3d=[0, 0, 0],s_3d=[1, 1, 1], has3d=1, specialfpname="", specialtags=specialtags,add_description=add_description,classname=clname, lib_name=lbname, name_additions=name_additions, script3d=script3d_rh, height3d=height3d)
    type="box"; pins=2; rm=2.54; dled=1.8; dledout=3.3; wled=3; wledback=1.6; height3d=2.4; height3d_bottom=1.6; name_additions=None; specialtags=[""]; add_description=""
    for ledypos in [1.65, 1.65+3.3, 1.65+3.3*2]:
        for offset in offsets:
            makeLEDHorizontal(ledypos=ledypos, pins=pins, rm=rm, ddrill=ddrill,dled=dled, dledout=dledout, wledback=wledback, offsetled=offset, wled=wled, type=type, x_3d=[0, 0, 0],s_3d=[1, 1, 1], has3d=1, specialfpname="", specialtags=specialtags,add_description=add_description,classname=clname+"", lib_name=lbname, name_additions=name_additions, script3d=script3d_rreh, height3d=height3d)
    type="box"; pins=2; rm=2.54; dled=5; dledout=5; wled=9.7; wledback=0; height3d=2; height3d_bottom=1.6; name_additions=None; specialtags=["Rectangular"]; add_description=""
