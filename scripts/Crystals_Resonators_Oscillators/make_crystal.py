...
class CrystalResonatorOscillatorGenerator(FootprintGenerator):
    ...
    def makeSMDCrystal(
        ...
        desc = (
            description
            + ", {0:2.1f}x{1:2.1f}mm^2 package, generated by make_crystal.py".format(
        ...
        kicad_modg.append(
            Property(
                ...
                at=[
                    0,
                    max(t_slk + h_slk, overpad_height / 2, pack_height / 2)
                    + txt_offset,
                ],
                layer="F.Fab",
            )
        ...
        if style == "hc49":
            ...
            allBevelRect(
                kicad_modg, [l_fab, t_fab], [w_fab, h_fab], "F.Fab", lw_fab, pack_bevel
            )
            if upright_mark:
                kicad_modg.append(
                    Line(
