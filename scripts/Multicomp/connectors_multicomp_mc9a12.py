...
kicad_mod.addRectLine({'x':roundG(start_pos_x-3.87-1.2-0.5,0.05), 'y':3.2+0.5}, {'x':roundG(end_pos_x+3.87+1.2+0.5,0.05), 'y':roundG(-pad_spacing-3.2-0.5,0.05)}, 'F.CrtYd', 0.05)
