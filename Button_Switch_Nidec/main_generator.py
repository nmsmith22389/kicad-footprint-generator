...
def make_models(model_to_build=None, output_dir_prefix=None, enable_vrml=True):
    ...
    for model in models:
        ...
        inset_color = shaderColors.named_colors[
            all_params[model]["inset_color_key"]
        ].getDiffuseFloat()
        cover_color = shaderColors.named_colors[
            all_params[model]["cover_color_key"]
        ].getDiffuseFloat()
        pin_color = shaderColors.named_colors[
            all_params[model]["pin_color_key"]
        ].getDiffuseFloat()
        ring_color = shaderColors.named_colors[
            all_params[model]["pin_color_key"]
        ].getDiffuseFloat()
        ...
        component.add(
            ...
            color=cq_color_correct.Color(
                inset_color[0], inset_color[1], inset_color[2]
            ),
        )
        component.add(
            cover,
            color=cq_color_correct.Color(
                cover_color[0], cover_color[1], cover_color[2]
            ),
        )
        component.add(
        ...
        component.add(
            ring,
            color=cq_color_correct.Color(ring_color[0], ring_color[1], ring_color[2]),
        )
