...
class PartBaseExt(PartBase):
    ...
    def _make_angular_gullwing_pin(
        ...
        if r_lower_i is None:
            r_lower_i = (
                params["pin_thickness"] / 2.0 if r_upper_i is None else r_upper_i
            )
        ...
        r_upper_o = (
            r_upper_i + params["pin_thickness"]
        )  # pin upper corner, outer radius
        r_lower_o = (
            r_lower_i + params["pin_thickness"]
        )  # pin lower corner, outer radius
        ...
        bottom_length = params["pin_bottom_length"] - (
            r_lower_o * sin(radians(pin_angle / 2.0))
        )
        top_length = (
            params["pin_length"]
            - bottom_length
        ...
        return (
            PolylineExt(cq.Workplane("YZ"), origin=(0, pin_height))
            ...
            .addPoint(-top_length, 0)
            .make()
            .extrude(params["pin_width"])
            .translate((-params["pin_width"] / 2.0, 0, 0))
        )
...
class buttonSwitchBody:  # partParams):
    ...
    def __pocketCenterHoleBottom(self):
        return (
            cq.Workplane("XY")
            .circle(self.params["bottom_center_hole_dia"] / 2.0)
            .extrude(self.params["bottom_pocket_depth"])
        )
    ...
    def __pocketEdgePinBottom(self):
        return (
            ...
            .rect(
                (
                    self.params["body_length_without_pads"]
                    - self.params["pocket_edge_pin_length"]
                ),
                (self.params["body_width"] - self.params["pocket_edge_pin_width"]),
                forConstruction=True,
            )
            .vertices()
            .rect(
                self.params["pocket_edge_pin_length"],
                self.params["pocket_edge_pin_width"],
            )
            .extrude(self.params["bottom_pocket_depth"])
        )
    ...
    def __pocketMidPinBottom(self):
        return (
            ...
            .vertices()
            .rect(
                self.params["pocket_mid_pin_length"],
                self.params["pocket_edge_pin_width"],
            )
            .extrude(self.params["bottom_pocket_depth"])
        )
        ...
        pocket = (
            cq.Workplane(
                ...
                origin=(
                    (
                        self.params["body_length_without_pads"]
                        + self.params["pad_side_length"]
                    )
                    / 2.0,
                    (self.params["body_width"] - self.params["pad_side_width"]) / 2.0,
                    self.params["body_height"] - self.params["pad_side_height"],
                ),
            )
            .rect(self.params["pad_side_length"], self.params["pad_side_width"])
            .extrude(self.params["pad_side_height"])
            .edges(">X")
            .edges("|Z")
            .fillet(0.2)
        )
    ...
    def __pocketTurnInset(self):
        return (
            cq.Workplane("XY", origin=((0.0, 0.0, self.params["body_height"])))
            .circle(self.params["turn_inset_dia"] / 2.0)
            .extrude(-self.params["pocket_turn_inset_top_depth"])
        )
            ...
            cq.Workplane(
                ...
                origin=(
                    (
                        0.0,
                        (
                            self.params["body_width"]
                            - self.params["pocket_top_side_width"]
                        )
                        / 2.0,
                        self.params["body_height"],
                    )
                ),
            )
            .rect(self.params["body_length"], self.params["pocket_top_side_width"])
            .extrude(-self.params["pocket_top_side_width"])
        )
    ...
    def makePlasticBody(self, params):
        ...
        body = (
            cq.Workplane("XY")
            .rect(params["body_length_without_pads"], params["body_width"])
            .extrude(params["body_height"])
            .edges("<Y")
            .edges("|Z")
            .fillet(0.1)
        )
        ...
        body = (
            body.union(self.__padsSide(), body)
            .edges(">Y")
            .edges("|Z")
            .fillet(0.1)
            .edges(">Z")
        ...
        body = (
            body.cut(self.__pocketCenterHoleBottom())
    ...
    def makeTurnInset(self, params):
        ...
        body = (
            cq.Workplane("XY")
            .circle(self.params["turn_inset_dia"] / 2.0)
            .extrude(self.params["turn_inset_height"])
        )

        arrow = (
            Polyline(cq.Workplane("XY"))
            .addMoveTo(
                -(self.params["arrowshaft_length"] + self.params["arrowhead_length"])
                / 2.0,
                -self.params["arrowshaft_height"] / 2.0,
            )
            ...
            .addPoint(
                -self.params["arrowhead_length"], -self.params["arrowhead_height"]
            )
            .addPoint(0.0, self.params["arrow_barb_height"])
            .addPoint(-self.params["arrowshaft_length"], 0.0)
            .make()
            .extrude(-self.params["arrow_pocket_depth"])
            .translate((0.0, 0.0, self.params["turn_inset_height"]))
        )
        ...
        return body.translate(
            (
                ...
                0.0,
                self.params["body_height"]
                - self.params["pocket_turn_inset_top_depth"]
                + self.params["body_board_distance"],
            )
        )
    ...
    def __pocketCoverEdges(self):
        ...
        pocket = (
            Polyline(cq.Workplane("XY"))
            .addMoveTo(
                self.params["body_length"] / 2.0 - self.params["pad_side_width"] + c,
                self.params["body_width"] / 2.0 - c,
            )
            .addPoint(-c, 0.0)
            .addPoint(0.0, c)
            ...
            .addPoint(0.0, c)
            .make()
            .extrude(self.params["body_height"])
        )
    ...
    def __pocketCoverSideClip(self):
        pocket = (
            cq.Workplane("XY")
            .box(
                self.params["body_length"],
                self.params["cover_side_pocket_width"],
                self.params["cover_side_pocket_height"],
            )
            .translate(
                (
                    0.0,
                    0.0,
                    self.params["cover_height"]
                    - self.params["cover_thickness"]
                    - self.params["cover_side_pocket_height"] / 2.0,
                )
            )
        )
        return pocket
    ...
    def makeCoverPlate(self, params):
        ...
        pocket = (
            cq.Workplane("XY")
            .rect(
                self.params["body_length"] - self.params["cover_thickness"] * 2.0,
                self.params["body_width"] - self.params["cover_thickness"] * 2.0,
            )
            .extrude(self.params["cover_height"] - self.params["cover_thickness"])
        )
        body = (
            body.cut(pocket)
            .cut(self.__pocketCoverEdges())
            .cut(
                cq.Workplane("XY").box(
                    self.params["body_length"] - 2.0 * self.params["cover_thickness"],
                    self.params["body_width"],
                    (self.params["body_height"] - self.params["pad_side_height"]) * 2.0,
                )
            )
    ...
    def makeNumberRing(self, params):
        ...
        :rtype: ``solid``
        """
        ring = cq.Workplane("XY").text("0", params["number_font_size"], 1.0)
...
class switchNidecSH70x0x(PartBaseExt):  # , partParams):
    ...
    def _duplicatePins(
        self, onePin, params, codeFormat=CodeFormat.REAL, noPins=None, pitch=None
    ):
    ...
    def _makeGwPin(self, params):
        return self._make_angular_gullwing_pin(
            params["pin_height"], params["pin_bottom_length"], params
        )
    ...
    def _makeThPin(self, params):
        return (
            self._make_angled_pin(
                params, params["pin_height"], params["pin_top_length"], 0.0, "THT"
            )
    ...
    def makePins(self, params):
        ...
        pins = self._duplicatePins(
            firstPin.translate(params["first_pin_pos"]),
            params,
