...
class cq_coaxial_molex:
    ...
    def make_top_SMA_Molex_73251_2200(self, params):
        ...
        case = (
            cq.Workplane("XZ")
            .workplane(centerOption="CenterOfMass", offset=AY1)
            .moveTo(AX1, AZ1)
            .circle(AW1 / 2.0 - 0.5, False)
            .extrude(AL1)
        )
    ...
    def make_top_SMA_Molex_73251_1153(self, params):
        ...
        case = (
            cq.Workplane("XY")
            .workplane(centerOption="CenterOfMass", offset=AZ1)
            .moveTo(AX1, AY1)
            .circle(AW1 / 2.0 - 0.5, False)
            .extrude(AL1)
        )
    ...
    def make_top_U_FL_Molex_MCRF_73412_0110(self, params):
        ...
        case1 = (
            cq.Workplane("XY")
            .workplane(centerOption="CenterOfMass", offset=AZ)
            .moveTo(AX, AY)
            .circle((AW / 2.0), False)
            .extrude(AL)
        )
    ...
    def make_case_SMA_Molex_73251_2200(self, params):
        ...
        case1 = (
            cq.Workplane("XZ")
            .workplane(centerOption="CenterOfMass", offset=AY)
            .moveTo(AX, AZ)
            .circle(AW / 2.0, False)
            .extrude(AL)
        )
    ...
    def make_case_U_FL_Molex_MCRF_73412_0110(self, params):
        ...
        case1 = case1.translate(
            (0.0 - ((W / 1.1415) - 0.2), 0.0 - ((W / 1.1415) - 0.2), 0.0)
        )
        case = case.cut(case1)
